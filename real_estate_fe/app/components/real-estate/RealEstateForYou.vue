            ...
            <template #cover>
              <div class="relative aspect-4/3 overflow-hidden bg-gray-100">
                <div v-if="item.image_urls?.length > 1"
                  class="absolute bottom-2 left-2 flex items-center gap-1 bg-black/50 text-white text-xs px-1.5 py-0.5 rounded">
                  <IconCamera class="h-3 w-3" />
            ...
            <div class="flex flex-col gap-1.5">
              ...
              <div class="flex items-center justify-end mt-1">
                <button
                  ...
                  :class="item.isFavorite ? 'border-red-500 text-red-500' : ''" @click.stop="toggleFavorite(item.id)">
                  <IconHeart class="h-4 w-4" :class="item.isFavorite ? 'fill-red-500 text-red-500' : 'text-gray-400'" />
                </button>
              </div>
            </div>
          </n-card>
